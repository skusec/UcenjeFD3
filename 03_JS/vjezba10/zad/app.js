...
document.getElementById('izvedi').addEventListener('click', () => {
  ...
  switch (zadatak) {
    case '1':
      // Za uneseni cijeli broj veći od 2 i manji od 10M
      // ispiši je li prim broj.
      ...
      if (!Number.isInteger(broj)) {
        rezultat.innerHTML = 'Moraš unijeti cijeli broj!'
        return
      }

      if (broj <= 2 || broj >= 10000000) {
        rezultat.innerHTML = 'Broj mora biti veći od 2 i manji od 10M!'
        return
      }
